    ...
    <main class="main-container">
        ...
        <section class="main-content">
            <div class="section-wrapper">
                <h2 class="section-title">📘 宝可梦图鉴</h2>
                <div class="search-container">
                    <form action="tujian.php" method="get">
                        <input type="text" name="search" placeholder="搜索宝可梦名字" value="<?php echo htmlspecialchars($search); ?>">
                ...
                <div class="filter-container">
                    <a href="tujian.php?search=<?php echo htmlspecialchars($search);?>&type=全部&page=<?php echo $page;?>">
                        <button>全部</button>
                    </a>
                    <?php
                    $types = [];
                    ...
                    ?>
                        <a href="tujian.php?search=<?php echo htmlspecialchars($search);?>&type=<?php echo htmlspecialchars($type);?>&page=<?php echo $page;?>">
                ...
                <div class="pokemon-list">
                    <?php foreach ($filteredPokemon as $pokemon):?>
                        <div class="pokemon-card" onclick="window.location.href='xiangqing.php?name=<?php echo urlencode($pokemon['name']); ?>'">
                            ...
                            <img src="tupian/<?php echo htmlspecialchars($pokemon['name']);?>.jpg" alt="<?php echo htmlspecialchars($pokemon['name']);?>">
